...
export class ProductItem extends Component<Props,State>{
    ...
    render(){
        return <div className="card m-1 p-1 bg-light">
            ...
            <div className="card-text bg-white p-1">
                ...
                <button className="btn btn-success btn-sm float-right" onClick={this.handleAddToCart}>Add To Cart</button>
    ...
    handleQuantityChange = (ev:ChangeEvent<HTMLSelectElement>):void => this.setState({
